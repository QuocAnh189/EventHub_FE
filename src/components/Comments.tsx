...
//interface
import { IMetadataReviewResponse, initParamsReview, IReviewEventPayload } from '@type/event'

//redux
import { useAppSelector } from '@hooks/useRedux'
import { IReview } from 'interfaces/contents/review'
import { useGetReviewsByEventIdQuery, useAddReviewMutation, useDeleteReviewMutation } from '@redux/services/eventApi'
