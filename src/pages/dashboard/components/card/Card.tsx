...
const Card = (props: CardProp) => {
  ...
  return (
    <div className={'card-item hover:cursor-pointer' + (isCardFlipped ? '-active' : '')}>
      <div className='card-item__side -front'>
        ...
        <div className='card-item__wrapper'>
          <div className='card-item__top'>
            <img src={'/card-asserts/chip.png'} alt='' className='card-item__chip' />
      ...
      <div className='card-item__side -back'>
        ...
        {/* <div className='card-item__cvv'>
          ...
          <div className='card-item__cvvBand'>
            <TransitionGroup>
              {cardCvv.split('').map((val: any, index: React.Key | null | undefined) => (
                <CSSTransition classNames='zoom-in-out' key={index} timeout={250} val={val}>
                  <span>*</span>
                </CSSTransition>
              ))}
            </TransitionGroup>
